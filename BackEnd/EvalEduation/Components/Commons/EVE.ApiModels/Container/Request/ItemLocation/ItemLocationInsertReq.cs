...
{
    [Validator(typeof(ItemLocationInsertValidator))]
    public class ItemLocationInsertReq : ItemLocationBaseReq
    {
    ...
    public class ItemLocationInsertValidator : AbstractValidator<ItemLocationInsertReq>
    {
    }
}
